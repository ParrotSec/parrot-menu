...
proc fixDebLaunchers() =
  ...
  let blacklistLauncherName = [
    ...
    "parrot-clusterd.desktop",
    "parrot-cryptkeeper.desktop",
    "parrot-ghost-phisher.desktop",
    "parrot-gr-scan.desktop",
    "parrot-hexorbase.desktop",
    "parot-intersect.desktop",
    "parrot-inundator.desktop",
    "parrot-jad.desktop",
    "parrot-keimpx.desktop",
    "parrot-magictree.desktop",
    "parrot-miranda.desktop",
    "parrot-mitmf.desktop",
    "parrot-nfspy.desktop",
    "parrot-pdfbook.desktop",
    "parrot-pdgmail.desktop",
    "parrot-powerfuzzer.desktop",
    "parrot-proxystrike.desktop",
    "parrot-pyrit.desktop",
  ]
